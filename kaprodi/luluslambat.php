<?php
    ...
    include_once '../naivebayes/hasilprediksi.php';
?>
    <div id="konten" >
   <?php 
  ...
  if(isset($_GET['nim'])){
    ...
    $tampil = mysqli_query($connect, "select * from MahasiswaHasil WHERE Prediksi IN('Lambat') Order By nim LIMIT $mulai, $halaman")or die(mysql_error);   
  }
