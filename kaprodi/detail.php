<?php
    ...
    include_once '../naivebayes/menentukanprediksi.php';
    include_once '../naivebayes/kategoritesting.php';
    include_once '../naivebayes/nilaiminimal.php';
...
<br/>
		...
		<table id='tbl-import' >
			...
			<br/>
                ...
                <tbody>
                	<?php 
					$sqldetail3 = "select IPS1,IPK,TotalSKS,JumD,JumE From MinimalMahasiswa where Nim = '$nim' ";
		...
		<table id="tbl-detaildua" >
					...
					<tr>
						<td width="40%">
							Sistem ini hanya membantu memprediksi kelulusan setiap mahasiswa, namun mahasiswa dapat lulus dengan tepat atau tidak tergantung dari mahasiswa 
							<br/>
							itu sendiri. 
						</td>
					</tr>
